...
<main>
    ...
    <c:choose>
        ...
        <%-- Carrito usuario anonimo --%>
        <c:otherwise>
            <c:choose>
                <c:when test="${not empty carritoAnonimo}">
    <table class="tabla-carrito">
        <thead>
            <tr>
                <th>Producto</th>
        ...
        <tbody>
            <c:forEach var="linea" items="${carritoAnonimo}" varStatus="status">
                <c:set var="producto" value="${productosAnonimos[status.index]}" />
                <tr>
                    <td>
    ...
    <div class="carrito-resumen">
        <p>Inicia sesion para finalizar tu pedido</p>
        <a href="login" class="btn-finalizar">Iniciar sesion</a>
